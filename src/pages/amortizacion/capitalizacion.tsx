  ...
  return (
    <>
      <div className="flex flex-wrap">
                <form 
                    id="formulario-capitalizacion" 
                    className="basis-1/4" 
                    noValidate 
                    onSubmit={submitCapitalizacion}
                >
                    ...
                    <div className="form-control w-full max-w-xs py-3">
                        ...
                        <input 
                            ...
                            />
                        <label className="label">
                            <span className="label-text-alt">El valor a capitalizar no puede estar en blanco o ser negativo.</span>
                        </label>
                    </div>
                    ...
                    <div className="">
                        <button className="btn btn-active btn-primary">Mostrar tabla de capitalización</button>
                    </div>
                </form>
                ...
                <div className="basis-3/4">
                {
                    tablaCapitalizacion.length>0 && (
                        <>
                            <h3 className="my-3">Tabla de Capitalización
                            </h3>
